...
import edu.unizg.foi.nwtis.hluksic20.vjezba_07_dz_2.klijenti.RestKlijentKazne;
import edu.unizg.foi.nwtis.hluksic20.vjezba_07_dz_2.podaci.Kazna;
import edu.unizg.foi.nwtis.hluksic20.vjezba_07_dz_2.podaci.PodaciKazne;
...
public class PosluziteljKazni {
  ...
  public String obradaZahtjeva(String zahtjev) {
    ...
    try {
      ...
      } else if (this.predlozakTest.matcher(zahtjev).matches()) {
        odgovor = obradaZahtjevaTest();
      } else {
  ...
  private String obradaZahtjevaTest() {
    return "OK";
  }
  ...
  private String obradaZahtjevaVozilo(String zahtjev) {
    ...
    // TODO salji POST na servis za pracenje kazni i vrati OK
    return sb.toString();
  }
  ...
  public String obradaZahtjevaKazna(String zahtjev) {
    ...
    if (!new RestKlijentKazne().postKaznaJSON(new Kazna(
